...
def get_rag_prompt(question: str, contexts: str, personal_instruction: str = "") -> str:
    return (
        ...
        "If the source content can only partially answer the question, provide the information available and explicitly state that the rest is missing from the provided sources.\n"
        "If the source content is completely irrelevant, reply: 'Based on the currently provided information, I cannot answer this question.' Under no circumstances should you return an empty response.\n\n"
